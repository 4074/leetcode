...
- Group
    ...
    - [140\. Word Break](./topics/dp/word-break-ii.md)
...
- Palindromic
    ...
    - [132\. Palindrome Partitioning II](./topics/dp/palindrome-partitioning-ii.md)
    - [516\. Longest Palindromic Subsequence](./topics/dp/longestPalindromicSubsequence.md)
    ...
    - [1771\. Maximize Palindrome Length From Subsequences](./topics/dp/maximize-palindrome-length-from-subsequences.md)
- Buy And Sell Stock
...
- Two Players Game
    ...
    - [1563\. Stone Game V](./topics/dp/stone-game-v.md)
...
- Binary Search
    ...
    - [154\. Find Minimum in Rotated Sorted Array II](./topics/search/find-minimum-in-rotated-sorted-array-ii.md)
    ...
    - [1802\. Maximum Value at a Given Index in a Bounded Array](./topics/search/maximum-value-at-a-given-index-in-a-bounded-array.md)
- Union Find
...
- Sliding Window
    - [209\. Minimum Size Subarray Sum](./topics/array/minimum-size-subarray-sum.md)    
    - [1052\. Grumpy Bookstore Owner](./topics/array/grumpy-bookstore-owner.md)
    - [1425\. Constrained Subsequence Sum](./topics/dp/constrained-subsequence-sum.md)
    - [1438\. Longest Continuous Subarray With Absolute Diff Less Than or Equal to Limit](./topics/array/longest-continuous-subarray-with-absolute-diff-less-than-or-equal-to-limit.md)
    - [1498\. Number of Subsequences That Satisfy the Given Sum Condition](./topics/array/number-of-subsequences-that-satisfy-the-given-sum-condition.md)
- Hash Table
...
- Two Pointers
    ...
    - [209\. Minimum Size Subarray Sum](./topics/array/minimum-size-subarray-sum.md)
    - [611\. Valid Triangle Number](./topics/array/valid-triangle-number.md)
